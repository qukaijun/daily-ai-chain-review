...
REQUIRED_FILES = [
    ...
    "market_calendar/trading_calendar.py",
    "output/notification_builder.py",
    "graph/multi_agent_layer.py",
    ...
    "scripts/check_trading_calendar.py",
    "scripts/check_trading_window.py",
    "scripts/notify_daily_review.py",
