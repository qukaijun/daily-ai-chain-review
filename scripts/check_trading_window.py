...
from market_calendar.trading_calendar import calendar_metadata, is_trading_day, review_window_status  # noqa: E402
...
def main() -> int:
    ...
    print(f"[INFO] calendar_source: {metadata.get('source_title', '') or 'weekday/env fallback'}")
    print(f"[INFO] calendar_files: {len(metadata.get('files', []))}")
